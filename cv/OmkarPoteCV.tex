  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        Lab under \href{https://scholar.google.co.in/citations?user=LItoQlMAAAAJ&hl=en}{\underline{Prof. Rajagopalan Srinivasan}}.
        }
        \resumeItem{ Focused on Explainable AI methods for Fault Detection and Diagnosis in Process Monitoring Systems. 
        }
        \resumeItem{ Increased the reliability and trustworthiness of black-box AI systems used by chemical plant operators with varying domain expertise and experience.
        }
        \resumeItem{ Developed model-agnostic, counterfactual-based explainability techniques for multivariate time series classification.
        }
      \resumeItemListEnd
